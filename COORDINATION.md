...
- Next: issue #8 (single-shell PTY transport, Codex-owned) is the only unblocked slice; #9/#10 blocked on #7+#8, #12/#13 blocked on #11 (now unblocked — promote next wave together with #8).
