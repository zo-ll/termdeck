# Termdeck coordination archive — rotation 2026-09-08

Moved verbatim from COORDINATION.md at dc6cfcf. These are historical
records, including headings formerly interleaved with handoffs; they do
not describe current status. Earlier archives remain in
`.coordinator/journal/`. Current dashboard: `../COORDINATION.md`.
